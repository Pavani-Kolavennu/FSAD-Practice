	...
	public static void main(String[] args)
	{
	    ...
	    static void createTables() 
	    {
	        try (Connection con = DriverManager.getConnection(url, user, password);
	            ...
	            String deptTable = "CREATE TABLE IF NOT EXISTS department (dept_id INT PRIMARY KEY,dept_name VARCHAR(50))";

	            String empTable = "CREATE TABLE IF NOT EXISTS employee (emp_id INT PRIMARY KEY,emp_name VARCHAR(50),salary DOUBLE,dept_id INT,FOREIGN KEY (dept_id) REFERENCES department(dept_id) )";
